...
This is a data science project to analyze customer service requests data set. The following are the tasks performed in each of the jupyter note book files.
